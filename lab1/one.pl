student(101,'Густобуквенникова').  % MTH
student(101,'Безумников'). % INF
student(101,'Мышин').
...
student(102,'Биткоинов'). % PSY
student(102,'Шарпин').
student(102,'Эксель').
student(102,'Текстописов'). % LP
student(102,'Криптовалютников'). % FP MTH PSY
student(102,'Азурин'). % MTH PSY
student(102,'Круглотличников').

student(103,'Текстописова'). % PSY
student(103,'Вебсервисов'). % PSY
student(103,'Решетников').
student(103,'Эфиркина'). % ENG INF LP
student(103,'Сиплюсплюсов').
student(103,'Программиро').
student(103,'Клавиатурникова').
student(103,'Сидоркин').

student(104,'Запорожцев'). % LP MTH
student(104,'Фулл').
student(104,'Блокчейнис'). % MTH
student(104,'Круглосчиталкин'). % MTH
student(104,'Джаво'). % INF
student(104,'Иванов').
